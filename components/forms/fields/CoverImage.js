        ...
        <div className="max-w-lg flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
          <div className="space-y-1 text-center">
            ...
            <div className="flex text-sm justify-center text-gray-600">
              <label
                htmlFor={name}
                className="relative cursor-pointer px-2 font-medium text-happy-yellow hover:text-happy-yellow bg-happy-middark focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500"
              >
                {imageSrc ? (
